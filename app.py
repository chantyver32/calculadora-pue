...
# 3. Diccionario de productos (Mantenido igual)
productos = {
    "": 0,
...
with col_b:
    ...
    peso_tara = st.number_input("Peso Tara:", min_value=0.0, format="%.4f", step=0.0001, value=None, placeholder="0.0000", key="tara_input") if usar_tara else 0.0
...
if btn_calcular:
    if not opcion:
        ...
        # Mostrar resultados dentro del bloque de cálculo
