...
/* Inputs de Streamlit */
div[data-baseweb="input"] input { color:#FFFFFF !important; background-color:#444444 !important; }
div[data-baseweb="select"] * { font-size:14px !important; cursor:pointer !important; }
div.stButton > button {
